    ...
    var Zitopay = function () {
        return {
            ...
            // remove the localhost from the url below so that temp_url = "https://zitopay.africa.sci? ..."
                if (window.location.hostname == 'localhost') {temp_url = temp_prot + '//zitopay.africa/sci?' + temp_url;console.log(temp_url)}
                ...
                if (document.getElementById('zitopayPaymentIframe')) {
                    ...
                    var styles = "@media (max-width:400px) {" +
                        ...
                        "width:94% !important;left:2% !important;" +
                        "}" +
                    ...
                    var cssText = 'position:absolute;z-index:100001;width:100%;min-width:98vw;height:' + temphstr + ';top:0px;left:0px;padding-top:10px;background-color:rgba(25, 20, 67,0.7);text-align:center;';
                    ...
                    cssText = 'position:absolute;z-index:10000000;color:#ff9900;cursor:pointer;font-weight:bold;font-size:120%;top:25px;left:10%;';
                    ...
                    document.getElementById('zitopayPaymentOverlay').appendChild(closeSpan);

                    cssText = 'position:absolute;z-index:10000000;color:#ffffff;font-weight:bold;font-size:200%;top:30%;left:0px;width:100%;text-align:center;'
                    ...
                    document.getElementById('zitopayPaymentOverlay').appendChild(loadingSpan);

                    cssText = 'position:relative;width:80%;left:10%;top:10px;min-width:280px;max-width:100vw;min-height:650px;overflow-x:hidden;border-radius:8px;';
